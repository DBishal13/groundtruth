...
| Signal | Read it as |
|---|---|
| 0–1 pilot-level commitments (LOI or paid pilot) | Pain is unconfirmed or budget doesn't exist here — keep researching or drop it. |
| 2–3 pilot-level commitments | Promising — worth a real scoping conversation and a heavier prototype. |
| 3+ commitments or one signed paid pilot | Evidence says go — convert the strongest conversation into a first paid engagement before writing more code than the pilot needs. |

Score honestly against real conversations, not vibes — that was the whole point of doing them.
